...
export default function Company() {
  return (
    <section className="w-full h-full bg-linear-to-b from-[#6E7644] to-primary text-white px-4 py-10 lg:px-10 xl:h-150 xl:px-20 2xl:px-32 2xl:py-20">
      <div className="flex flex-col items-center gap-10 lg:flex-row lg:gap-12 xl:gap-16">
        <div className="flex flex-col space-y-6 lg:flex-1">
          ...
          <button
            type="button"
            className="w-fit bg-secondary text-primary px-10 py-4 cursor-pointer font-medium brand-font hover:brightness-110 transition duration-300"
          >
            Learn More
          </button>
        </div>
